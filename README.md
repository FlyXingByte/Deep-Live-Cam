...
If you manage your dependencies with **Anaconda** on Windows, use the provided
`run-anaconda-cuda.bat` script to automatically activate the `deeplivecam`
environment and launch the GPU version.
